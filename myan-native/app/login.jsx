...
const styles = StyleSheet.create({
  ...
  title:   { color: COLORS.text, fontSize: 20, fontWeight: '600', marginBottom: 12, textAlign: 'center' },
  desc:    { color: COLORS.textMuted, fontSize: 15, textAlign: 'center', marginBottom: 40, lineHeight: 22, paddingHorizontal: 16 },
