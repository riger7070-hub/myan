...
const 글들 = [
  ...
  // ⚠️ 여기까지 네 편은 2026-08-31 기준으로 이미 올라갔다. 아래가 남은 것이다.
  { 순서: 5, 이름: '목기운', 글번호: '', 짧은이름: '초록',
    사진: ['insta/mok.png', 'blog/shots/manseryeok.png'],
    설명: ['목 기운 카드', '만세력이 오행 비율을 내주는 실제 화면'] },
  { 순서: 6, 이름: '삼재', 글번호: '', 짧은이름: '삼재',
    사진: ['insta/samjae-2026.png', 'blog/shots/samjae.png'],
    설명: ['2026년 삼재 카드', '1987년생(토끼띠)으로 계산한 실제 화면'] },
];
