...
const ICONS = {
  ...
  // 작명: 이름을 적어 매다는 패
  //
  // ⚠️ 이름 풀이(name)와 나란히 놓인다. 둘 다 붓으로 그리면 목록에서 구분이 안 되므로
  //    이쪽은 '이름표' 로 간다.
  naming: S(`<path d="M11.5 3.5h7a2 2 0 0 1 2 2v7L11 22a2 2 0 0 1-2.8 0l-6.2-6.2a2 2 0 0 1 0-2.8Z"/>
             <circle cx="16.6" cy="7.4" r="1.5"/>
             <path d="M7.5 12.5l4 4M10.5 9.5l4 4" opacity=".55"/>`),
  // 속궁합: 겹쳐 안기는 두 결
  intimacy: S(`<path d="M12 20.5S4.5 15.8 4.5 10.4A3.9 3.9 0 0 1 12 8.6a3.9 3.9 0 0 1 7.5 1.8c0 5.4-7.5 10.1-7.5 10.1Z"/>
               <path d="M8.6 10.4a3.4 3.4 0 0 1 2-2.6" opacity=".55"/>`),
  // 올해 세운: 한 해를 도는 원과 그 안의 표시
  yearluck: S(`<circle cx="12" cy="12" r="8.5"/>
               <path d="M12 6.6v5.6l3.6 2.2"/>
               <path d="M20.2 8.4 21.8 7M3.8 8.4 2.2 7"/>`),
  // 이사 방위: 나침반의 바늘
  direction: S(`<circle cx="12" cy="12" r="9"/>
                <path d="M15.2 8.8 10.6 10.6 8.8 15.2 13.4 13.4Z"/>
                <path d="M12 3v1.6M12 19.4V21M3 12h1.6M19.4 12H21"/>`),
  // 재물운: 주머니에 담긴 엽전
  wealth: S(`<path d="M6.5 9.5h11l2 5.2a5.2 5.2 0 0 1-4.8 7.3H9.3a5.2 5.2 0 0 1-4.8-7.3Z"/>
             <path d="M8.6 9.5c0-2.2 1.5-3.6 3.4-3.6s3.4 1.4 3.4 3.6"/>
             <circle cx="12" cy="15.6" r="2.8"/><rect x="10.9" y="14.5" width="2.2" height="2.2"/>`),
  // 신살: 칼과 꽃 — 살(殺)은 흉하기만 한 게 아니라 쓰기 나름이다
  sinsal: S(`<path d="M7 20.5 17.5 4.5"/><path d="M5 18.5 8.5 22"/>
             <circle cx="7.5" cy="7.5" r="2.6"/>
             <path d="M7.5 10.1v3.4M5.2 6.2 3 4.8M9.8 6.2 12 4.8"/>`),
  // 전생: 되감기는 실타래
  pastlife: S(`<path d="M20.5 12a8.5 8.5 0 1 1-2.6-6.1"/>
               <path d="M20.5 3.5V9h-5.4"/>
               <circle cx="12" cy="12" r="2.4"/>`),
  // 천직: 자리를 잡은 연장 — 손잡이와 날
  vocation: S(`<rect x="3" y="8" width="18" height="12" rx="2"/>
               <path d="M8.5 8V6a2 2 0 0 1 2-2h3a2 2 0 0 1 2 2v2"/>
               <path d="M3 13h18M11 13v2.5h2V13"/>`),
  // 오늘의 띠 순위: 층이 진 단상
  ttirank: S(`<path d="M4 20.5h16"/>
              <rect x="9.4" y="6" width="5.2" height="14.5"/>
              <rect x="15" y="10.5" width="5" height="10"/>
              <rect x="4" y="13.5" width="5" height="7"/>
              <path d="M12 3.2l.7 1.6 1.7.2-1.3 1.2.4 1.7-1.5-.9-1.5.9.4-1.7-1.3-1.2 1.7-.2Z"/>`),
