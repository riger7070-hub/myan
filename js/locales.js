...
const TX = {
  ko:{
    ...
    quickExperienceTitle:'각종 체험', quickExperienceDesc:'타로·주역·관상 등 다양한 콘텐츠',
    experienceHubTitle:'각종 체험', experienceHubSub:'궁금한 콘텐츠를 골라보세요',
  ...
  en:{
    ...
    quickExperienceTitle:'All Experiences', quickExperienceDesc:'Tarot, I-Ching, face reading & more',
    experienceHubTitle:'All Experiences', experienceHubSub:"Pick a content you're curious about",
  ...
  zh:{
    ...
    quickExperienceTitle:'各种体验', quickExperienceDesc:'塔罗·周易·面相等多种内容',
    experienceHubTitle:'各种体验', experienceHubSub:'选择您感兴趣的内容',
  ...
  ja:{
    ...
    quickExperienceTitle:'各種体験', quickExperienceDesc:'タロット・易経・観相など多彩なコンテンツ',
    experienceHubTitle:'各種体験', experienceHubSub:'気になるコンテンツを選んでください',
