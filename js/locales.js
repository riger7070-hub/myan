...
const TX = {
  ko:{
    ...
    takilTitle:'이 일에 좋은 날', takilSub:'만세력으로 고르는 결혼·이사·개업 날짜 (엽전 2)', takilLoading:'역서를 넘겨 보는 중...',
    ...
    daeunTitle:'지금 나는 어느 10년', daeunSub:'10년마다 바뀌는 운의 결 (엽전 3)', daeunLoading:'대운을 세우는 중...',
    ...
    nameTitle:'내 이름에 담긴 기운', nameSub:'한글 이름의 발음오행과 사주의 궁합 (엽전 2)', nameLoading:'이름을 소리로 풀어 보는 중...',
    ...
    ctTitle:'이 사람과 좋은 때', ctSub:'두 사람에게 언제가 좋은 때인지 (엽전 3)', ctLoading:'두 분의 시기를 맞춰 보는 중...',
    ...
    drDreamTitle:'꿈해몽', drDreamSub:'꿈 내용을 적으면 안도령이 풀어 드려요 (엽전 1)',
    dreamTitle:'꿈해몽', dreamPlaceholder:'어떤 꿈을 꾸셨나요? (예: 물에 빠지는 꿈을 꿨어요)', dreamSubmitBtn:'해몽 보기', dreamLoading:'꿈을 해몽하는 중...',
    drLottoTitle:'오늘의 로또번호', drLottoSub:'오늘의 기운으로 뽑는 행운번호 (엽전 1)',
  ...
  en:{
    ...
    drDreamTitle:'Dream Interpretation', drDreamSub:'Your dream, interpreted (1 token)',
    ...
    drLottoTitle:"Today's Lucky Numbers", drLottoSub:'Lucky numbers from today’s energy (1 token)',
  ...
  ja:{
    ...
    drDreamTitle:'夢占い', drDreamSub:'夢を解き明かします（トークン1）',
    dreamTitle:'夢占い', dreamPlaceholder:'どんな夢を見ましたか？（例：水に落ちる夢を見ました）', dreamSubmitBtn:'夢を占う', dreamLoading:'夢を占っています…',
    drLottoTitle:'今日のラッキーナンバー', drLottoSub:'今日の気運で選ぶ幸運の数字（トークン1）',
