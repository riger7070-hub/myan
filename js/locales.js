...
const TX = {
  ko:{
    ...
    detailTitle:'상세 풀이', detailSub:'깊이 들여다보기', detailLoading:'안도령이 깊이 살펴보는 중... (약 10초)',
    ...
    luckyNumber:'행운숫자', luckyDir:'행운방향', luckyStone:'행운석',
    ...
    takilTitle:'이 일에 좋은 날', takilSub:'만세력으로 고르는 결혼·이사·개업 날짜', takilLoading:'역서를 넘겨 보는 중...',
    ...
    daeunTitle:'지금 나는 어느 10년', daeunSub:'10년마다 바뀌는 운의 결', daeunLoading:'대운을 세우는 중...',
    ...
    nameTitle:'내 이름에 담긴 기운', nameSub:'한글 이름의 발음오행과 사주의 궁합', nameLoading:'이름을 소리로 풀어 보는 중...',
    ...
    ctTitle:'이 사람과 좋은 때', ctSub:'두 사람에게 언제가 좋은 때인지', ctLoading:'두 분의 시기를 맞춰 보는 중...',
    ...
    drLuckySub:'럭키 컬러·음식·노래 추천',
    luckyTitle:'오늘의 행운 아이템', luckyLoading:'오늘의 행운을 찾는 중...', luckyColor:'행운색', luckyFood:'럭키 음식', luckySong:'럭키 무드',
    drTypeSub:'나의 유형 찾고 궁합 보기',
    typeTitle:'오행으로 보는 두 사람', typeProgress:'{n} / {total}', typeResultTitle:'당신의 유형은',
    ...
    drFortuneSub:'짝사랑·가족·미래 등 궁금한 운세를 골라보세요',
    fortuneModalTitle:'궁금한 것만 골라 보기', fortuneModalSub:'궁금한 주제를 골라보세요', fortuneLoading:'기운을 살펴보는 중...',
    ...
    drIchingSub:'동전을 던져 괘를 뽑아보세요',
    ichingTitle:'주역으로 물어보기', ichingAskPlaceholder:'궁금한 것을 적어보세요 (선택)', ichingCastBtn:'괘 뽑기',
    ichingCasting:'괘를 뽑는 중...', ichingChanging:'변효',
    drNumerologySub:'생년월일로 보는 숫자점',
    numerologyTitle:'숫자로 보는 내 성향', numerologyLoading:'숫자를 계산하는 중...', numerologyNeedBirth:'먼저 마이페이지에서 생년월일을 등록해 주세요.', numerologyYourNumber:'당신의 라이프패스 넘버',
    drTojeongSub:'올 한 해 신수를 짚어보세요',
    tojeongTitle:'토정비결 신년운세', tojeongLoading:'한 해의 신수를 살펴보는 중...', tojeongNeedBirth:'먼저 마이페이지에서 생년월일을 등록해 주세요.', tojeongNotice:'정통 토정비결 원문이 아닌, 사주를 바탕으로 AI가 그 정신을 살려 생성한 신년운세입니다.',
    // 미니앱에만 있던 콘텐츠 11종을 웹으로 옮기며 추가한 이름표들.
    wealthTitle:'돈이 모이는 자리', sinsalTitle:'내 사주에 앉은 살', gwiinTitle:'누가 나를 도와줄까', pastlifeTitle:'전생에 나는 누구였나', vocationTitle:'이 길이 내 길이 맞을까', namingTitle:'아이 이름 지을 때', directionTitle:'나에게 좋은 방향', yearluckTitle:'올해 나에게 오는 것', intimacyTitle:'속궁합', relationTitle:'왜 자꾸 이 사람과 어긋날까', relAsk:'어떤 사이인지 고르고, 상대의 생년월일을 넣어 주세요.', relAny:'고르지 않음', relLover:'연인', relSpouse:'부부', relFamily:'가족', relFriend:'친구', relWork:'같이 일하는 사이', spouseTitle:'내 짝은 어떤 사람', ttirankTitle:'오늘의 띠 순위',
    csLove:'궁합과 인연', csName:'이름과 인상',
    readingLoading:'풀이를 준비하는 중…', namingAsk:'성(姓)을 알려 주세요', namingPlaceholder:'예: 김', namingRun:'풀이 받기',
    factSinsal:'신살', factNoSinsal:'뚜렷한 신살 없음', factSamjaeNow:'삼재 (지금)', factSamjaeNext:'다음 삼재', factGwiinPeople:'내 귀인', factGwiinStars:'사주에 선 귀인', factGwiinYears:'귀인이 드는 해', factGung:'본명궁', factGoodDir:'좋은 쪽', factBadDir:'꺼리는 쪽', factWealthShape:'재물의 결', factWealthYears:'재물이 드는 해', factSipsinTop:'두드러진 십신', factMyTti:'내 띠', factSpouseGung:'배우자궁',
    drPhotoSub:'사진으로 보는 얼굴·손금 풀이',
    ...
    csMe:'사주로 보는 나', csTiming:'때와 방위', csAsk:'물어보는 점',
    tmCostTitle:'엽전으로 할 수 있는 것',
    tmCostNote:'사주 리딩은 엽전 1개, 두 사람 궁합은 엽전 2개입니다. 풀이가 만들어지지 않으면 엽전은 자동으로 돌려드립니다.',
    mercuryRetro:'수성 역행',
  ...
  en:{
    ...
    guestLoading:'Reading your chart...',
    ...
    detailTitle:'Detailed Reading', detailSub:'A Closer Look', detailLoading:'Looking closer... (~10 sec)',
    ...
    luckyNumber:'Lucky Number', luckyDir:'Lucky Direction', luckyStone:'Lucky Stone',
    ...
    drZodiacSub:"Today's animal & star sign fortune",
    ...
    takilTitle:'Date Picking', takilSub:'Pick a wedding, moving or opening date from the almanac', takilLoading:'Turning the almanac pages...',
    ...
    daeunTitle:'Great Fortune Cycles', daeunSub:'The ten-year currents of your life', daeunLoading:'Building your cycles...',
    ...
    nameTitle:'Name Reading', nameSub:'The five elements in the sound of a Korean name', nameLoading:'Reading the sound of the name...',
    ...
    ctTitle:'Timing Together', ctSub:'When the good years fall for the two of you', ctLoading:'Lining up your years...',
    ...
    drLuckySub:'Lucky color · food · mood',
    ...
    drTypeSub:'Find your type & check compatibility',
    ...
    drFortuneSub:'Crush, family, future & more',
    ...
    drIchingSub:'Toss coins to draw a hexagram',
    ...
    drNumerologySub:'Number reading from your birth date',
    ...
    drTojeongSub:"This year's outlook",
    ...
    wealthTitle:'Wealth Fortune', sinsalTitle:'Sinsal Reading', gwiinTitle:'Find Your Benefactor', pastlifeTitle:'Past Life', vocationTitle:'Calling & Aptitude', namingTitle:'Naming Guidance', directionTitle:'Moving Direction', yearluckTitle:"This Year's Fortune", intimacyTitle:'Intimate Compatibility', relationTitle:'How You Two Fit', relAsk:'Choose how you know them, then enter their birth date.', relAny:'Not specified', relLover:'Partner', relSpouse:'Spouse', relFamily:'Family', relFriend:'Friend', relWork:'Colleague', spouseTitle:'Spouse Palace', ttirankTitle:"Today's Zodiac Ranking",
    csLove:'Compatibility & Bonds', csName:'Name & Impression',
    readingLoading:'Preparing your reading…', namingAsk:'What is your family name?', namingPlaceholder:'e.g. Kim', namingRun:'Get reading',
    factSinsal:'Sinsal', factNoSinsal:'No prominent sinsal', factSamjaeNow:'Samjae (now)', factSamjaeNext:'Next Samjae', factGwiinPeople:'Your benefactors', factGwiinStars:'Benefactor stars in chart', factGwiinYears:'Benefactor years', factGung:'Natal palace', factGoodDir:'Favourable directions', factBadDir:'Directions to avoid', factWealthShape:'Shape of wealth', factWealthYears:'Years wealth arrives', factSipsinTop:'Dominant Sipsin', factMyTti:'Your sign', factSpouseGung:'Spouse palace',
    drPhotoSub:'Photo-based face/palm reading',
    ...
    drDreamSub:'Your dream, interpreted',
    ...
    drLottoSub:'Lucky numbers from today’s energy',
    ...
    drRuneSub:"Today's energy through Norse runes",
    ...
    csMe:'Reading yourself', csTiming:'Time & direction', csAsk:'Asking a question',
    tmCostTitle:'What your tokens buy',
    tmCostNote:'A solo reading costs 1 token and a compatibility reading costs 2. If a reading cannot be produced, your tokens are returned automatically.',
  ...
  zh:{
    ...
    detailTitle:'详细解读', detailSub:'深入解读', detailLoading:'正在深入解读...（约10秒）',
    ...
    luckyNumber:'幸运数字', luckyDir:'幸运方向', luckyStone:'幸运石',
    ...
    takilTitle:'择日 · 挑选吉日', takilSub:'依万年历挑选嫁娶·搬迁·开业的日子', takilLoading:'正在翻阅历书...',
    ...
    daeunTitle:'大运 · 十年流转', daeunSub:'每十年更替一次的运势脉络', daeunLoading:'正在排大运...',
    ...
    nameTitle:'姓名解读', nameSub:'韩文姓名的发音五行与八字的配合', nameLoading:'正在从声音解读姓名...',
    ...
    ctTitle:'合婚时机', ctSub:'两人之间何时是好时候', ctLoading:'正在对照两人的流年...',
    ...
    wealthTitle:'财运', sinsalTitle:'神煞解读', gwiinTitle:'寻找贵人', pastlifeTitle:'前世故事', vocationTitle:'天职与才能', namingTitle:'取名参考', directionTitle:'搬家方位', yearluckTitle:'今年流年', intimacyTitle:'亲密合婚', relationTitle:'与这个人的关系', relAsk:'请选择你们的关系，并填入对方的出生日期。', relAny:'不指定', relLover:'恋人', relSpouse:'夫妻', relFamily:'家人', relFriend:'朋友', relWork:'同事', spouseTitle:'配偶宫解读', ttirankTitle:'今日生肖排行',
    csLove:'合婚与缘分', csName:'姓名与印象',
    readingLoading:'正在准备解读…', namingAsk:'请告诉我您的姓', namingPlaceholder:'例：金', namingRun:'获取解读',
    factSinsal:'神煞', factNoSinsal:'无明显神煞', factSamjaeNow:'三灾（当前）', factSamjaeNext:'下次三灾', factGwiinPeople:'我的贵人', factGwiinStars:'命中的贵人', factGwiinYears:'贵人之年', factGung:'本命宫', factGoodDir:'吉方', factBadDir:'忌方', factWealthShape:'财的格局', factWealthYears:'进财之年', factSipsinTop:'突出的十神', factMyTti:'我的生肖', factSpouseGung:'配偶宫',
    drPhotoSub:'通过照片查看面相·手相',
    ...
    csMe:'从八字看自己', csTiming:'时机与方位', csAsk:'问卜',
    tmCostTitle:'代币可以用在哪里',
    tmCostNote:'单人八字解读为1代币，两人合婚为2代币。若未能生成解读，代币会自动退回。',
    mercuryRetro:'水星逆行',
  ...
  ja:{
    ...
    detailTitle:'詳細リーディング', detailSub:'詳しく見る', detailLoading:'詳しく見ています...（約10秒）',
    ...
    luckyNumber:'ラッキーナンバー', luckyDir:'ラッキー方向', luckyStone:'ラッキーストーン',
    ...
    takilTitle:'択日 · 良い日選び', takilSub:'万年暦で選ぶ結婚・引っ越し・開業の日', takilLoading:'暦をめくっています...',
    ...
    daeunTitle:'大運 · 十年の流れ', daeunSub:'十年ごとに移り変わる運の質', daeunLoading:'大運を立てています...',
    ...
    nameTitle:'名前の解読', nameSub:'ハングル名の発音五行と四柱の相性', nameLoading:'名前を音から読み解いています...',
    ...
    ctTitle:'相性の時期', ctSub:'二人にとっていつが良い時かを見ます', ctLoading:'二人の流年を照らし合わせています...',
    ...
    drFortuneSub:'片思い・家族・未来など気になる運勢',
    ...
    wealthTitle:'金運', sinsalTitle:'神殺の読み解き', gwiinTitle:'貴人さがし', pastlifeTitle:'前世の物語', vocationTitle:'天職と適性', namingTitle:'名づけの参考', directionTitle:'引っ越しの方位', yearluckTitle:'今年の運勢', intimacyTitle:'相性（親密）', relationTitle:'この人との関係', relAsk:'どんな間柄かを選び、相手の生年月日を入れてください。', relAny:'選ばない', relLover:'恋人', relSpouse:'夫婦', relFamily:'家族', relFriend:'友人', relWork:'仕事仲間', spouseTitle:'配偶者宮の読み解き', ttirankTitle:'今日の干支ランキング',
    csLove:'相性と縁', csName:'名前と印象',
    readingLoading:'読み解きを準備しています…', namingAsk:'姓を教えてください', namingPlaceholder:'例：金', namingRun:'読み解きを受ける',
    factSinsal:'神殺', factNoSinsal:'際立った神殺なし', factSamjaeNow:'三災（現在）', factSamjaeNext:'次の三災', factGwiinPeople:'私の貴人', factGwiinStars:'命式に立つ貴人', factGwiinYears:'貴人の年', factGung:'本命宮', factGoodDir:'吉方', factBadDir:'忌む方位', factWealthShape:'財の形', factWealthYears:'財が入る年', factSipsinTop:'際立つ十神', factMyTti:'私の干支', factSpouseGung:'配偶者宮',
    drPhotoSub:'写真で見る観相・手相',
    ...
    csMe:'四柱で見る自分', csTiming:'時と方位', csAsk:'問う占い',
    tmCostTitle:'トークンでできること',
    tmCostNote:'一人の四柱鑑定はトークン1、二人の相性はトークン2です。解説が作れなかった場合、トークンは自動的に返却されます。',
    mercuryRetro:'水星逆行',
...
function render() {
  ...
  if (guestSubtitleText) guestSubtitleText.textContent = t.guestSubtitle || '로그인 없이 사주 풀이를 무료로 1회 체험해보세요';
  ...
  if (guestSubmitBtn) guestSubmitBtn.textContent = t.guestSubmitBtn || '풀이 받기';
  if (guestResultTitleText) guestResultTitleText.textContent = t.guestResultTitle || '✨ 풀이 결과';
