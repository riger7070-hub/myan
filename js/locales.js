...
const TX = {
  ko:{
    ...
    oracleEnter:'문을 엽니다…', oracleFlip:'만세력을 넘깁니다…', oraclePillars:'사주 네 기둥을 세웁니다…', oracleExit:'기운이 도착했습니다.',
  ...
  en:{
    ...
    oracleEnter:'Opening the door…', oracleFlip:'Turning the pages of the almanac…', oraclePillars:'Raising the Four Pillars…', oracleExit:'Your reading has arrived.',
  ...
  zh:{
    ...
    oracleEnter:'推开门…', oracleFlip:'翻阅万年历…', oraclePillars:'排列四柱…', oracleExit:'解读已送达。',
  ...
  ja:{
    ...
    oracleEnter:'扉を開けます…', oracleFlip:'万歳暦をめくります…', oraclePillars:'四柱を立てます…', oracleExit:'鑑定が届きました。',
