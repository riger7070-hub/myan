...
const TX = {
  ko:{
    ...
    takilTitle:'좋은 날 고르기', takilSub:'만세력으로 고르는 결혼·이사·개업 날짜 (엽전 2)', takilLoading:'역서를 넘겨 보는 중...',
    ...
    daeunTitle:'10년마다 바뀌는 운', daeunSub:'10년마다 바뀌는 운의 결 (엽전 3)', daeunLoading:'대운을 세우는 중...',
    ...
    ctTitle:'궁합과 좋은 때', ctSub:'두 사람에게 언제가 좋은 때인지 (엽전 3)', ctLoading:'두 분의 시기를 맞춰 보는 중...',
    ...
    typeTitle:'오행 궁합 알아보기', typeProgress:'{n} / {total}', typeResultTitle:'당신의 유형은',
    ...
    numerologyTitle:'생일로 보는 나', numerologyLoading:'숫자를 계산하는 중...', numerologyNeedBirth:'먼저 마이페이지에서 생년월일을 등록해 주세요.', numerologyYourNumber:'당신의 라이프패스 넘버',
    ...
    wealthTitle:'재물운', sinsalTitle:'도화살·역마살 찾기', gwiinTitle:'나를 돕는 귀인', pastlifeTitle:'전생 이야기', vocationTitle:'천직과 적성', namingTitle:'이름 짓기 참고', directionTitle:'이사 갈 방향', yearluckTitle:'올해 운세', intimacyTitle:'속궁합', relationTitle:'이 사람과의 관계', relAsk:'어떤 사이인지 고르고, 상대의 생년월일을 넣어 주세요.', relAny:'고르지 않음', relLover:'연인', relSpouse:'부부', relFamily:'가족', relFriend:'친구', relWork:'같이 일하는 사이', spouseTitle:'내 짝은 어떤 사람', ttirankTitle:'오늘의 띠 순위',
