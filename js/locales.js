...
const TX = {
  ko:{
    ...
    wealthTitle:'재물운', sinsalTitle:'신살 풀이', gwiinTitle:'귀인 찾기', pastlifeTitle:'전생 이야기', vocationTitle:'천직과 적성', namingTitle:'작명에 참고할 결', directionTitle:'이사 방위', yearluckTitle:'올해 세운', intimacyTitle:'속궁합', spouseTitle:'배우자궁 풀이', ttirankTitle:'오늘의 띠 순위',
  ...
  zh:{
    ...
    wealthTitle:'财运', sinsalTitle:'神煞解读', gwiinTitle:'寻找贵人', pastlifeTitle:'前世故事', vocationTitle:'天职与才能', namingTitle:'取名参考', directionTitle:'搬家方位', yearluckTitle:'今年流年', intimacyTitle:'亲密合婚', spouseTitle:'配偶宫解读', ttirankTitle:'今日生肖排行',
  ...
  ja:{
    ...
    wealthTitle:'金運', sinsalTitle:'神殺の読み解き', gwiinTitle:'貴人さがし', pastlifeTitle:'前世の物語', vocationTitle:'天職と適性', namingTitle:'名づけの参考', directionTitle:'引っ越しの方位', yearluckTitle:'今年の運勢', intimacyTitle:'相性（親密）', spouseTitle:'配偶者宮の読み解き', ttirankTitle:'今日の干支ランキング',
